    ...
    <div className="space-y-12 max-w-6xl mx-auto pb-12">
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex items-center gap-4">
           <Button className="bg-emerald-500 hover:bg-emerald-400 text-black font-bold h-12 rounded-xl px-8 shadow-xl shadow-emerald-500/20 transition-all active:scale-95 group">
          ...
          <CardContent className="p-10 pt-4 space-y-10">
            <div className="flex items-center gap-10 pb-10 border-b border-white/5">
              ...
              <div className="space-y-3">
                <Button variant="outline" size="sm" className="h-10 border-white/10 text-white hover:bg-white/5 rounded-xl px-6 font-bold uppercase tracking-widest text-[10px]">Modify Logo</Button>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-3">
                <Label htmlFor="org-name" className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Legal Entity Name</Label>
                <Input id="org-name" className="bg-black/40 border-white/5 h-14 rounded-2xl focus:border-emerald-500/50 focus:ring-emerald-500/10 text-white placeholder:text-zinc-700 font-medium" defaultValue="MetaForce Global" />
              </div>
              <div className="space-y-3">
                <Label htmlFor="industry" className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Neural Sector</Label>
                <Input id="industry" className="bg-black/40 border-white/5 h-14 rounded-2xl focus:border-emerald-500/50 focus:ring-emerald-500/10 text-white placeholder:text-zinc-700 font-medium" defaultValue="Autonomous Systems" />
              </div>
              <div className="space-y-3">
                <Label htmlFor="website" className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Global Domain</Label>
                <div className="relative">
                  <Globe2 className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" />
                  <Input id="website" className="pl-11 bg-black/40 border-white/5 h-14 rounded-2xl focus:border-emerald-500/50 focus:ring-emerald-500/10 text-white placeholder:text-zinc-700 font-medium" defaultValue="https://metaforce.ai" />
                </div>
              </div>
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <Input id="email" className="pl-11 bg-black/40 border-white/5 h-14 rounded-2xl focus:border-emerald-500/50 focus:ring-emerald-500/10 text-white placeholder:text-zinc-700 font-medium" defaultValue="hq@metaforce.ai" />
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-zinc-900/40 backdrop-blur-3xl border-white/5 rounded-[2.5rem] overflow-hidden group">
          <CardHeader className="p-10 pb-4 border-b border-white/5 bg-white/[0.01]">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 gap-2 font-bold uppercase tracking-widest text-[10px] h-9 px-4 rounded-full">
          ...
          <CardContent className="p-10 pt-10 space-y-10">
            <div className="grid md:grid-cols-2 gap-10">
              <div className="space-y-3">
                ...
                <Input defaultValue="103948572104938" readOnly className="border-white/5 bg-black/40 font-mono text-xs h-14 rounded-2xl text-emerald-500/80 cursor-default" />
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between px-1">
                ...
                <Input defaultValue="948572103948572" readOnly className="border-white/5 bg-black/40 font-mono text-xs h-14 rounded-2xl text-emerald-500/80 cursor-default" />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-4">
                <Input type="password" value="EAAQZA8Y0ZB948572103948572103948572" readOnly className="border-white/5 bg-black/40 font-mono text-xs flex-1 h-14 rounded-2xl text-zinc-500 cursor-default" />
            ...
            <div className="flex justify-between items-center pt-10 border-t border-white/5">
              ...
              <Button variant="outline" className="h-12 border-white/10 hover:bg-white/5 text-emerald-400 hover:text-emerald-300 px-8 rounded-xl font-bold uppercase tracking-widest text-[10px] transition-all active:scale-95">
                Verify Connection
              </Button>
            </div>
          </CardContent>
